...
def index_element(lst, start, stop) -> list:
    index_elements = {}
    for item in range(len(lst)):
        if (lst[item] > start-1 and lst[item] < stop+1):
            index_elements[item] = lst[item]

    return index_elements



print(index_element([-5, 9, 0, 3, -1, -2, 1, 4, -2, 10, 2, 0, -9, 8, 10, -9, 0, -5, -5, 7], 2, 10))
print(index_element([-5, 9, 0, 3, -1, -2, 1, 4, -2, 10, 2, 0, -9, 8, 10, -9, 0, -5, -5, 7], 2, 9))
print(index_element([-5, 9, 0, 3, -1, -2, 1, 4, -2, 10, 2, 0, -9, 8, 10, -9, 0, -5, -5, 7], 0, 6))